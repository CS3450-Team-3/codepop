# Spint 0 Summary: Requirement Gathering 
**Team Lead:** 

# Sprint 1 Summary: Desgin
...
**Ethan H.** focused heavily on backend development and infrastructure. He helped lead the migration to Docker, ensuring the project could run consistently across systems. He also worked extensively on API development, server setup, and database stability, while maintaining scalability and organization across the codebase.
...
**Dillian** focused on backend systems, testing, and infrastructure. He played a major role in Dockerization, created automation scripts for server setup and testing, and worked on peer-to-peer networking and server synchronization. He also developed logistic manager pages, API endpoints, and geolocation functionality.
