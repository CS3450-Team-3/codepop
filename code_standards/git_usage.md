...
- Test your work often to avoid surprises
  - When doing backend work, ensure your code passes all tests using:
    ```bash
    python manage.py test
    ```
  - It's more difficult with frontend, as we don't have any predefined tests yet; ensure that the general UI still works and that what you worked on functions as intended.
