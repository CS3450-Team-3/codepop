...
urlpatterns = [
    ...
    path('users/<uuid:user_id>/preferences/', UserPreferenceLookup.as_view(), name='user_preferences_list'),
    ...
    path('drinks/<uuid:pk>/', drink_detail, name='drink operations'),
    ...
    path('users/<uuid:user_id>/drinks/', UserDrinksLookup.as_view(), name='user_preferences_list'),
    ...
    path('users/<uuid:user_id>/notifications/', UserNotificationLookup.as_view(), name='user notifications list'),
    ...
    path('users/<uuid:user_id>/orders/', UserOrdersLookup.as_view(), name='user_orders_list_create'),
    ...
    path('users/<uuid:user_id>/orders/<uuid:pk>/', order_detail, name='user_order_detail'),
    ...
    path('revenues/<uuid:pk>/', revenue_details, name='revenue_detail'),
