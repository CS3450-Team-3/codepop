    ...
    try {
      ...
      if (SodaUsed.length == 0) {
        ...
        const response = await fetch(
          `${BASE_URL}/backend/drinks/${drink.DrinkID}/`,
          {
            method: "PUT",
            headers: {
            ...
            body: JSON.stringify({
              ...
              SyrupsUsed,
              AddIns,
              Price: 2.0, // Adjust price as needed
              User_Created: true,
              Size: selectedSize,
              Ice: selectedIce,
            }),
    ...
    <View style={styles.wholePage}>
            ...
            {["none", "light", "regular", "extra"].map((ice) => (
              ...
              >
                <Text
                  style={[
                    styles.buttonText,
                    selectedIce === ice && styles.selectedButtonText,
                  ]}
                >
                  {ice}
                </Text>
      ...
      /> */}
          <DropDown
            ...
            isOpen={openDropdown.sodas}
            setOpen={() =>
              setOpenDropdown((prev) => ({ ...prev, sodas: !prev.sodas }))
            }
          ...
          <DropDown
            ...
            setOpen={() =>
              setOpenDropdown((prev) => ({ ...prev, syrups: !prev.syrups }))
            }
          ...
          <DropDown
            ...
            setOpen={() =>
              setOpenDropdown((prev) => ({ ...prev, juices: !prev.juices }))
            }
